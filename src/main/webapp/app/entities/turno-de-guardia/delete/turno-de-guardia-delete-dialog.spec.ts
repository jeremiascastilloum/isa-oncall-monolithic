...
import { TurnoDeGuardiaDeleteDialog } from './turno-de-guardia-delete-dialog';

describe('TurnoDeGuardia Management Delete Component', () => {
  let comp: TurnoDeGuardiaDeleteDialog;
  let fixture: ComponentFixture<TurnoDeGuardiaDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TurnoDeGuardiaDeleteDialog);
