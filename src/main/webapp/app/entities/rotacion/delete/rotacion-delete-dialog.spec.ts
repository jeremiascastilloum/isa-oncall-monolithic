...
import { RotacionDeleteDialog } from './rotacion-delete-dialog';

describe('Rotacion Management Delete Component', () => {
  let comp: RotacionDeleteDialog;
  let fixture: ComponentFixture<RotacionDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(RotacionDeleteDialog);
