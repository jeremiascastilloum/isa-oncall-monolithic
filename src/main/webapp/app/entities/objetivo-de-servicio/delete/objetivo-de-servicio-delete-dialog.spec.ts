...
import { ObjetivoDeServicioDeleteDialog } from './objetivo-de-servicio-delete-dialog';

describe('ObjetivoDeServicio Management Delete Component', () => {
  let comp: ObjetivoDeServicioDeleteDialog;
  let fixture: ComponentFixture<ObjetivoDeServicioDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ObjetivoDeServicioDeleteDialog);
