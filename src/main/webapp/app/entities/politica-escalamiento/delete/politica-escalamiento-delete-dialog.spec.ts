...
import { PoliticaEscalamientoDeleteDialog } from './politica-escalamiento-delete-dialog';

describe('PoliticaEscalamiento Management Delete Component', () => {
  let comp: PoliticaEscalamientoDeleteDialog;
  let fixture: ComponentFixture<PoliticaEscalamientoDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PoliticaEscalamientoDeleteDialog);
