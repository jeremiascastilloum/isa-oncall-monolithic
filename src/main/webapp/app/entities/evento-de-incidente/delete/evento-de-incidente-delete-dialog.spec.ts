...
import { EventoDeIncidenteDeleteDialog } from './evento-de-incidente-delete-dialog';

describe('EventoDeIncidente Management Delete Component', () => {
  let comp: EventoDeIncidenteDeleteDialog;
  let fixture: ComponentFixture<EventoDeIncidenteDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EventoDeIncidenteDeleteDialog);
