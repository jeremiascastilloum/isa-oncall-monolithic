...
@Component({
  ...
  templateUrl: './evento-de-incidente-delete-dialog.html',
  imports: [TranslateDirective, FormsModule, FontAwesomeModule, AlertError],
})
export class EventoDeIncidenteDeleteDialog {
  eventoDeIncidente?: IEventoDeIncidente;
  ...
  confirmDelete(id: number): void {
    this.eventoDeIncidenteService.delete(id).subscribe(() => {
