...
import { PostmortemDeleteDialog } from './postmortem-delete-dialog';

describe('Postmortem Management Delete Component', () => {
  let comp: PostmortemDeleteDialog;
  let fixture: ComponentFixture<PostmortemDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PostmortemDeleteDialog);
